...
const POINTS = [
  ...
  {
    label: "지금은 받지 않습니다",
    title: "결제 없이 전부 열려 있습니다",
    // 결제창이 아직 없으므로 "한 번만 결제하면" 같은 말을 쓰지 않습니다.
    body: `이력서와 명함은 앞으로도 무료입니다. 청첩장은 링크 발행이 열리는 날 ${formatPrice(PREMIUM_PRICE)}을 받을 예정이고, 그전까지는 만드는 것도 보는 것도 값이 없습니다.`,
  },
  {
    label: "골라 쓸 수 있게",
