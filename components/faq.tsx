...
const QA = [
  {
    q: "비용이 얼마인가요?",
    a: `청첩장을 만들어 링크로 보내 보는 것까지는 무료입니다. 무료 링크는 ${FREE_LINK_DAYS}일 뒤에 닫히므로, 청첩장을 정말 돌리실 때 ${formatPrice(PREMIUM_PRICE)}을 한 번만 결제하시면 예식일 +${PAID_GRACE_DAYS}일까지 유지됩니다. 참석 여부 집계·방명록·하객 스냅처럼 하객의 응답을 받는 기능과 꾸미기 추가분도 이때 함께 열립니다.`,
  },
  {
  ...
  },
  {
    ...
    a: `대표 사진 1장과 갤러리 사진 ${PREMIUM_EXTRAS.freeGalleryPhotos}장까지 무료이고, 결제하시면 갤러리 장수 제한이 없어집니다. 업로드한 사진은 자동으로 최적화되어 모바일에서도 빠르게 열립니다.`,
  },
  {
