/* 초대장 디자인 스무 벌.
   ...
   한 벌이 정하는 것은 세 가지뿐입니다 — 어떤 그림을 쓰는가, 그 그림
   위에서 글자를 어디에 앉히는가(cover), 글자가 놓이는 자리가 밝은가
   어두운가(tone). 글꼴은 전체가 두 벌로 통일되어 있고, 크기와 여백은
   토큰이 정합니다. 벌마다 자유롭게 정할 수 있는 것이 적을수록 스무 벌이
   한 벌의 물건으로 보입니다.
...
const SEEDS: Seed[] = [
  /* ══════════════════ 결혼 · 약혼 ══════════════════ */
  {
    ...
    name: "꽃 아치",
    occasion: "wedding",
    note: "작약과 유칼립투스로 두른 아치. 가운데가 비어 있어 이름이 그 안에 앉습니다.",
    cover: "open",
    tone: "light",
  },
  {
  ...
  },
  {
    ...
    name: "돌상",
    occasion: "baby",
    note: "무지개떡과 과일을 올린 돌상을 민화풍으로. 위쪽 한지 여백에 이름이 앉습니다.",
    cover: "head",
    tone: "light",
  },
  {
    ...
    name: "초승달 위",
    occasion: "baby",
    note: "초승달에 웅크려 잠든 토끼. 밤하늘이라 글자는 종이색으로 얹었습니다.",
    cover: "head",
    tone: "dark",
  },
  ...
  },
  {
    ...
    name: "돗자리",
    occasion: "party",
    note: "위에서 내려다본 소풍 한 장. 무늬가 촘촘해 글자는 종이 띠 위로 옮겼습니다.",
    cover: "panel",
    tone: "light",
  },
